                ...
                for (int i = 0; i < contours.size(); i++) {
                    ...
                    if (solidity >= 0.06 && solidity <= .2 && ratio <= 2.9 && momentYRatio >= .45) {
                        ...
                        if (points.size() >= 4) {
                            ...
                            // INFO : Algorithm
                            /*
                               Find bounding box (can be angled)
                               Top left = Top left of target
                               Top right = Top right of target

                               Find points near bottom line of bounding box
                               Furthest left = Bottom left of target
                               Furthest right = Bottom right of target
                             */
